...
<form action="{{ $searchAction }}" method="GET" role="search" class="hidden md:flex items-center">
    <div class="relative">
        ...
        <input
            ...
            placeholder="Keresés..."
            aria-label="Keresés"
            class="w-56 pl-9 pr-3 py-1.5 text-sm border border-gray-200 rounded-lg bg-gray-50 text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-400 focus:border-transparent transition"
        >
    </div>
</form>
