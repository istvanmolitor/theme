...
<form action="{{ $searchAction }}" method="GET" role="search" class="hidden md:flex items-center">
    <div class="relative">
        ...
        <input
            ...
            placeholder="Keresés..."
            aria-label="Keresés"
            class="w-56 pl-9 pr-3 py-1.5 text-sm border border-slate-700 rounded-lg bg-slate-900 text-slate-200 placeholder-slate-500 focus:outline-none focus:ring-1 focus:ring-slate-400 focus:border-slate-400 transition"
        >
    </div>
</form>
